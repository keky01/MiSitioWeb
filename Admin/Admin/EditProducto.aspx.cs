    ...
    public partial class EditProducto : paginaBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ddlTalle.DataSource = AddProducto.GetTallas().Tables[0];
                ddlTalle.DataBind();
        ...
        private void CargarDatos(int ProductoId)
        {
            ...
            ddlTalle.SelectedValue = dr["TallaId"].ToString();
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                producto.Talla.Id = Utils.utils.ToInt(ddlTalle.SelectedValue);
