...
<table width="200" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr id="divlnkAddVenta" >
      ...
      <td height="20" bgcolor="Yellow">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx">Nueva Venta</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="Yellow">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink
    ...
    <tr id="divlnkLogout" >
      ...
      <td height="20" bgcolor="Yellow" style="HEIGHT: 20px">
        <p>
